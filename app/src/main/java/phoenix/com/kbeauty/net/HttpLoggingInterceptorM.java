...
public final class HttpLoggingInterceptorM implements Interceptor {
        ...
        Logger DEFAULT = new Logger() {
            ...
            public void log(String message, @LogUtil.LogType int type) {
                ...
                Platform.get()
                        ...
                        .log(Platform.INFO, message, null);
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        LogUtilHelper.printLine(LogInterceptor.INTERCEPTOR_TAG_STR,true);
        ...
        if (logHeaders) {
            ...
            LogUtilHelper.printLine(LogInterceptor.INTERCEPTOR_TAG_STR,false);
